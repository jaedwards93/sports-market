...
WITH source_cte AS (
    ...
    SELECT
        ...
        (a.payload->>'commence_time')::timestamp(0) commence_time,
        a.payload->>'home_team' home_team,
        a.payload->>'away_team' away_team,
        bookmaker->>'key' bookmaker_key,
        bookmaker->>'title' bookmaker_title,
        (bookmaker->>'last_update')::timestamp(0) bookmaker_last_update,
        market->>'key' market_key,
        (market->>'last_update')::timestamp(0) market_last_update,
