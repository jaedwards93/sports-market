...
def events_ingest(batch_id: int, sport_key: str):
    odds_api_call = ApiCall(key_name='the_odds_api_key', url=f'https://api.the-odds-api.com/v4/sports/{sport_key}/events')
    ...
    insert_sql = """
            INSERT INTO raw_the_odds_api.events (json, batch_id)
            VALUES (%s, %s)
        """
