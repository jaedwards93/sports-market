...
def scores_ingest(batch_id: int, sport_key: str):
    additional_params = {
        'daysFrom': '3'
    }

    odds_api_call = ApiCall(key_name='the_odds_api_key', url=f'https://api.the-odds-api.com/v4/sports/{sport_key}/scores',
    ...
    insert_sql = """
            INSERT INTO raw_the_odds_api.scores (json, batch_id)
            VALUES (%s, %s)
        """
